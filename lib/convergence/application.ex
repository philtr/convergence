defmodule Convergence.Application do
  ...
  def start(_type, _args) do
    children = [
      ...
      # {Convergence.Worker, arg},
      # Start to serve requests, typically the last entry
      ConvergenceWeb.Endpoint
    ]

    # See https://hexdocs.pm/elixir/Supervisor.html
    # for other strategies and supported options
    opts = [strategy: :one_for_one, name: Convergence.Supervisor]
  ...
  def config_change(changed, _new, removed) do
    ConvergenceWeb.Endpoint.config_change(changed, removed)
    :ok
  end
end
